...
HEALTH_PERSONALITIES_ENDPOINT = build_url(HEALTH_ENDPOINT, VERSION1, 'personalities')
HEALTH_CLUSTER_ENDPOINT = build_url(HEALTH_ENDPOINT, VERSION1, 'cluster')
HEALTH_CLUSTER_CHECK_ENDPOINT = build_url(HEALTH_CLUSTER_ENDPOINT, 'check')
