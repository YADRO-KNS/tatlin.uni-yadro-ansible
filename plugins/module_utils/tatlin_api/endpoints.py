...
PERSONALITIES_BLOCK_ENDPOINT = build_url(
    PERSONALITIES_BASE_ENDPOINT, VERSION1, 'personalities', 'block'
)
PERSONALITIES_AUTH_ENDPOINT = build_url(PERSONALITIES_BLOCK_ENDPOINT, 'auth')
PERSONALITIES_CONFIG_ENDPOINT = build_url(
    PERSONALITIES_BASE_ENDPOINT, VERSION1, 'config'
)
PERSONALITIES_HOSTS_ENDPOINT = build_url(
    PERSONALITIES_CONFIG_ENDPOINT, 'hosts'
)
PERSONALITIES_HOST_GROUPS_ENDPOINT = build_url(
    PERSONALITIES_CONFIG_ENDPOINT, 'groups'
)
PERSONALITIES_RESOURCE_MAPPING_ENDPOINT = build_url(
    PERSONALITIES_CONFIG_ENDPOINT, 'resource_mapping'
)
